  ...
  return (
    <section className="relative w-full overflow-hidden" style={{ minHeight: "90vh" }}>
      ...
      <div className="relative z-10 h-full flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-[350px] relative z-20 px-6 py-10 md:py-16 mt-16 md:mt-24">
          <h2 className="text-white text-2xl font-tilt mb-8">OUR SPECIALTY</h2>
        ...
        <div className="flex-1 relative px-6 py-10 md:pt-16">
          {/* Social Media Icons */}
          <div className="absolute top-10 left-0 md:left-6">
            <p className="text-white mb-2">Follow On:</p>
          ...
          {/* Main Content */}
          <div className="mt-16 md:mt-24 flex flex-col md:flex-row">
            <div className="md:w-1/2 flex flex-col justify-center md:pr-6">
              <motion.h1 
                className="text-5xl md:text-7xl font-tilt text-white leading-tight mb-8"
              ...
              >
                ...
                <Button variant="outline" className="text-white border-white hover:bg-white/10 rounded-full w-12 h-12 p-0">
